...
//2
let numero1=30;
console.log(numero1<40);
//3
console.log(numero1<60);
//4
let numero2=24;
...
//7
const num3cifras=456;
let cadena=num3cifras.toString();
//console.log(cadena);
let resultado=(Number(cadena[0])+Number(cadena[1])+Number(cadena[2]))**2;
